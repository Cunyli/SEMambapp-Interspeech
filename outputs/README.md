...
Generated evaluation and inference outputs belong here. The advisor-facing
listening set is an allowlist of 3--5 deterministic sample IDs under
...
reason. See `outputs/examples/README.md`.
