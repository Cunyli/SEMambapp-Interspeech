...
TEST_FILES_JSON='["tests/test_artifact_layout.py","tests/test_avqi_components.py","tests/test_direct_avqi_waveform_optimization.py","tests/test_shifted_anechoic_target.py"]'
jq -n \
